                  ...
                  <div className="w-full flex gap-3">
                    ...
                    {product.stock > 0 && (
                      <button
                        ...
                        className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-green rounded-sm shadow hover:shadow-lg"
                      >
                        <ShoppingCartIcon />
                    ...
                    <button
                      ...
                      className={
                        product.stock < 1
                          ...
                          : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-green rounded-sm shadow hover:shadow-lg"
                      }
                    >
                      <FlashOnIcon />
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  {product.stock <= 10 && product.stock > 0 && (
                    <span className="text-red-500 text-sm font-medium">
                      Hurry, Only {product.stock} Kg left!
                    </span>
                  )}
                  {/* <!-- price desc --> */}
                  ...
                  {Array(3)
                    ...
                    .map((el, i) => (
                      <p className="text-sm flex items-center gap-1" key={i}>
                        ...
                        Instant discount on E-FARM Pay Later order of 500 and
                        above{" "}
                  ...
                  <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col">
                    ...
                    {/* <h1 className="px-6 py-3 text-lg">{product.specifications.title}</h1> */}
                    <div className="p-6">
                      <ul className="list-disc flex flex-col gap-2 w-64">
                      ...
                      {/* {product.specifications.map((spec, i) => (
                                            <div className="px-6 py-2 flex items-center text-sm" key={i}>
                                                <p className="text-gray-500 w-3/12">title</p>
